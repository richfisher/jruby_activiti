...
public class ProcessInstanceHighlights {
  ...
  public ProcessInstanceHighlights(RuntimeService runtimeService, RepositoryService repositoryService, HistoryService historyService){
